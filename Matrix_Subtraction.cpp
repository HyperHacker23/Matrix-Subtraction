//this program subtracts 2 matrices of any order
#include<iostream>
using namespace std;
int main()
{
...
//making the difference matrix a null matrix
        for(i=0;i<row1;i++)
        {
            for(j=0;j<col2;j++)
            {
...
//adding the 2 matrices and storing them in the difference matrix
        for(i=0;i<row1;i++)
        {
            for(j=0;j<col2;j++)
            {
